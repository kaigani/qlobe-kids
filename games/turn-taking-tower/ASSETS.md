...
Turn-Taking Tower adds no image files, recorded clips, downloaded assets,
generated art, or network assets. The current beta uses emoji block placeholders
and Web Speech lines rendered by the build-assemble engine.
...
| Emoji block placeholders | Local system emoji rendered by the browser | N/A | N/A | N/A | Used as temporary `emoji:` art refs |
...
- wooden block art in multiple colors
- optional cast turn portrait presentation for Maya, Sam, Nia, Ravi, and Leo
- recorded per-cast turn lines and tower celebration lines
