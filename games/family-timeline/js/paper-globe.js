// paper-globe.js — tactile, accurate globe interaction for Family Timeline.
//
...
export class PaperGlobe {
  constructor(options) {
    ...
    this.mount.classList.add('qk-paper-globe', 'qk-family-timeline-globe');
    this.mount.dataset.game = 'family-timeline';
    this.mount.replaceChildren();
    this.pinLayer = document.createElement('div');
    this.pinLayer.className = 'qk-paper-globe-pins qk-family-timeline-pins';
    this.pinLayer.dataset.game = 'family-timeline';
  ...
  buildPins() {
    for (const landmark of this.landmarks) {
      ...
      button.dataset.game = 'family-timeline';
  ...
  destroy() {
    ...
    this.mount.replaceChildren();
    this.mount.classList.remove('qk-paper-globe', 'qk-family-timeline-globe', 'is-aligned');
    delete this.mount.dataset.game;
  }
}
