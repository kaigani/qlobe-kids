...
Block Tower Measure adds no image files, recorded clips, downloaded assets, generated art, or network assets. The current beta uses emoji block placeholders rendered by the build-assemble engine.
