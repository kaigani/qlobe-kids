...
- Let's set the table. Put each thing in its place.
- Almost. Look for the place where that table thing belongs.
- This place setting is ready!
- Table mission complete! Now you can set the real table tonight!
- That belongs there!
- You are setting the table!
- Careful helper hands!
- Set the table. Plates, cups, and cutlery each have a place.
- A bowl goes on the plate spot.
- Bread goes on the plate spot.
- Salad goes on the plate spot.
- Milk goes on the cup spot.
- Juice goes on the cup spot.
