# Loose Parts Collage Assets

Loose Parts Collage adds no image files, recorded clips, downloaded assets,
...
| Emoji loose-part placeholders | Local system emoji rendered by the browser | N/A | N/A | N/A | Used as temporary `emoji:` art refs |
...
- photographed-style leaves, buttons, yarn, pinecones, twigs, and cotton loose parts
- finished collage reveal art
- recorded prompt, nudge, cheer, and picture voice lines
