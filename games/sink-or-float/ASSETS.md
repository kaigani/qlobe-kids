...
| `assets/title.webp` 620×560 | `assets/source/title-original.png` (from `01-game-concepts/_completed/sink-or-float-lab/title-asset-alpha.png`) | approved concept title artwork; transparent canvas alpha-trimmed with 20px side padding for responsive placement; encoded WebP q92 (743KB → 151KB) |
