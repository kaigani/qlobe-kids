...
| Globe and habitat placeholder art | N/A - Unicode emoji rendered by the browser through `emoji:*` refs | N/A | Platform/browser emoji font license | N/A | Used as temporary placeholders only |
...
### Art
- Spinning globe art or animation-ready scene art.
- Habitat scene pages for icy place, jungle, desert, and ocean.
- Sticker art for penguin, polar bear, seal, ice, monkey, parrot, snake, jungle leaves, camel, lizard, cactus, sun, whale, octopus, fish, and wave.
