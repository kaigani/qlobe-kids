...
| `shared/vendor/three.module.min.js` | [three.js](https://threejs.org/) | MIT | Existing QLOBE vendor copy reused by `paper-globe.js` (local, `games/globe-spin-stories/js/`); no CDN request. |
