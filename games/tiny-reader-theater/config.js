// config.js — thin shim so index.html/js keeps a single import shape.
//
// New engine games keep their content in config.json (plain data the studio can
// read and edit) and load it through this shim, so a game module always does
// the same `import config from '../config.js'` whether a game is data-in-JS or
// data-in-JSON.
//
