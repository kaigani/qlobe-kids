...
| Rhythm placeholder cards | N/A - Unicode emoji rendered by the browser through `emoji:*` refs | N/A | Platform/browser emoji font license | N/A | Used as temporary placeholders only |
...
### Art
- Kid clapping action pose art
- Kid stomping action pose art
- Kid patting action pose art
- Animal beat art for frog, bird, and lion

### Voice
- "Copy the rhythm pattern."
- "Listen to the beat. Which sound comes next?"
- "You copied the rhythms!"
- "Now do the pattern with your body!"
- "What body beat comes next? Watch and listen!"
- "What animal beat comes next? Watch and listen!"
- "clap!"
- "stomp!"
- "pat!"
- "ribbit!"
