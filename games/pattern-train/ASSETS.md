...
| HUD buttons (`shared/assets/ui/btn-home.png`, `btn-sound.png`, `btn-play.png`) | Shared QLOBE Kids library | Generated for this project | CC BY 4.0 | No | Reused by `shared/js/engines/pattern-continue.js` |
| Train-car placeholder cards | N/A - Unicode emoji rendered by the browser through `emoji:*` refs | N/A | Platform/browser emoji font license | N/A | Used as temporary placeholders only |
...
- Red train-car art
- Blue train-car art
- Yellow train-car art
- Triangle train-car art
- Circle train-car art
- Square train-car art

### Voice
- "The pattern train needs its next cars."
- "Listen to the train. Which car comes next?"
- "Hooray! The pattern train is rolling!"
- "Chugga chugga, the pattern keeps going!"
- "Yes! That car fits!"
- "Nice train pattern!"
- "What color car comes next? Watch the train!"
- "What shape car comes next? Watch the train!"
- "red"
- "blue"
- "yellow"
- "triangle"
