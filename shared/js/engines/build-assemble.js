...
function installStyle() {
  ...
  style.textContent = `
    ...
    .qk-build-home { position: absolute; top: max(12px,env(safe-area-inset-top)); left: max(12px,env(safe-area-inset-left)); z-index: 5; }
    ...
    .qk-build-hud .qk-build-home { position: static; }
